...
Recall 은 각 방법이 문제를 풀었을때 오답이 존재하든 말든 정답만 맞추면 장땡임을 나타내는 척도 입니다.

따라서 어떠한 문제에 대한 해결 방법을 평가할때

해당 방법이 정답을 모두 못맞추더라도 오답을 내지 않는 것이 중요하다면 Recall 보다 **Precision** 의 수치가 높은 방법을 선택하는 것이 좋고

해당 방법이 오답을 내더라도 정답만 잘 맞추는게 중요하다면 Precision 보다 **Recall** 의 수치가 높은 방법을 선택하는 것이 좋습니다.
