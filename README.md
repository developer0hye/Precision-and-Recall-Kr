...
A 는 2 개의 서로 다른 부분을 내놓았고 그 중 정답은 2개 이니 Precision 은 2/2 = 1.0 으로 이를 % 로 나타내면 100% 입니다. 

B 는 5 개의 서로 다른 부분을 내놓았고 그 중 정답은 3개 이니 Precision 은 3/5 = 0.75 로 이를 % 로 나타내면 75% 입니다.
