...
우선 **Precision** 과 **Recall** 을 설명하기에 앞서 우리가 해결해야할 문제를 정의하고 문제를 해결하기 위한 방법에 대한 성능 평가 척도로 **Precision** 과 **Recall** 을 실제 문제에 해봄으로써 설명을 드리겠습니다.
...
그리고 B 방법은 모자, 접시, 소스를 모두 잘 찾아냈지만 뒤집개를 잘못 판단하여 뒤집개 또한 변한 부분으로 판단하였습니다.

그렇다면 A 방법과  B 방법 중 어느 방법이 더 좋다고 판단할 수 있을까요??
